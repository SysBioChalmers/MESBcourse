...
Data is here is classified as either pheromone-affected or pheromone-unaffected. The count data files are located in the **data/gene_counts/** subdirectory in the **'RNAseq1_DEanalysis'** directory.
...
1. Start R and use setwd() (or Session > Set Working Directory > Choose Directory… from the top menu bar) to change the working directory to the RNAseq1_DEanalysis/ directory, which should contain a subdirectory named data/.
```{r setup, include=FALSE,warning=FALSE,echo=TRUE,message=FALSE}
knitr::opts_chunk$set(echo = TRUE)
# setwd("~/Documents/Course/MESB/RNAseq1_DEanalysis")
